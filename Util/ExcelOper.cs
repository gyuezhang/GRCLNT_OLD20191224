                ...
                for (int i = 2; i <= sheet.LastRowNum; i++)
                {
                    ...
                    if (row != null)
                    {
                        try
                        {
                            ...
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "乡镇街道为空");
                                continue;
                            }
                            ...
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "所属村为空");
                                continue;
                            }
                            ...
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "位置为空");
                                continue;
                            }
                            ...
                            if (row.GetCell(4) != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "经度值超出宝坻界");
                                        continue;
                                    }
                                    else
                                    {
                                ...
                                {
                                    OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "经度值格式不正确");
                                    continue;
                                }
                            }
                            else
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "经度值为空");
                                continue;
                            }
                            ...
                            if (row.GetCell(5) != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "纬度值超出宝坻界");
                                        continue;
                                    }
                                    else
                                    {
                                ...
                                {
                                    OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "纬度值格式不正确");
                                    continue;
                                }
                            }
                            else
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "纬度值为空");
                                continue;
                            }
                            ...
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "权属单位为空");
                                continue;
                            }
                            ...
                            if (row.GetCell(8) != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "成井时间超出适用范围");
                                        continue;
                                    }
                                }
                                catch
                                {
                                    OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "成井时间格式错误");
                                    continue;
                                }
                            }
                            else
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "成井时间为空");
                                continue;
                            }
                            ...
                            if (row.GetCell(9) != null)
                            {
                                ...
                                {
                                    OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "井深格式错误");
                                    continue;
                                }
                            }
                            else
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "井深为空");
                                continue;
                            }
                            ...
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "管材为空");
                                continue;
                            }
                            ...
                            if (row.GetCell(11) != null)
                            {
                                ...
                                {
                                    OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "井管内径格式错误");
                                    continue;
                                }
                            }
                            else
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "井管内径为空");
                                continue;
                            }
                            ...
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "水泵型号为空");
                                continue;
                            }
                            ...
                            if (row.GetCell(17) != null)
                            {
                                ...
                                {
                                    OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "水泵功率内径格式错误");
                                    continue;
                                }
                            }
                            else
                            {
                                OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "水泵功率内径为空");
                                continue;
                            }
                            ...
                            wells.Add(tempWell);
                            OnReadWell(true, i - 1, sheet.LastRowNum - 1, wells, "Done");


                        }
                        catch (Exception e)
                        {
                            OnReadWell(false, i - 1, sheet.LastRowNum - 1, wells, "未知错误");
                            continue;
                        }
                    }
                }
                OnReadWell(true, sheet.LastRowNum - 1, sheet.LastRowNum - 1, wells, "Finished");
            }
            catch (Exception e)
            {
